...
--tenname_to_tenid = shard.tenname_to_tenid:select{"admin"}
--print(tenname_to_tenid)
print("!!!!!   2")
...
--print_r(shard.tenid_to_tenname:select{"admin"})

local uname_to_uid = {}
uname_to_uid = shard.uname_to_uid:select{"admin"}
